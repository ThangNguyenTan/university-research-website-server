...
const JobModel = __importStar(require("../model/jobs"));
let JobService = class JobService {
    getJobs() {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                const jobs = yield JobModel.getJobs();
                return (0, helpers_1.generateResponse)(200, "Success", { jobs });
            }
            catch (error) {
                console.log(error);
    ...
    createJob(bodyData, _token = "") {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                const job = yield JobModel.createJob(bodyData);
                return (0, helpers_1.generateResponse)(200, "Success", { job });
            }
            catch (error) {
                console.log(error);
                return (0, helpers_1.generateResponse)();
    ...
    updateJob(jobName, bodyData, _token = "") {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                return (0, helpers_1.generateResponse)(200, "Successfully Updated", { job: updatedJob });
            }
            catch (error) {
                console.log(error);
                return (0, helpers_1.generateResponse)();
...
], JobService.prototype, "getJobs", null);
__decorate([
    (0, tsoa_1.Post)("/"),
...
__decorate([
    (0, tsoa_1.SuccessResponse)(200, "Successfully Updated"),
