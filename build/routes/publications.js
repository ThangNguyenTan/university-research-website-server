...
exports.default = (router) => {
    ...
    router.patch("/publication/:title/participants/:personId", controller.assignParticipantToPublication);
    router.delete("/publication/:title", controller.deletePublication);
    router.delete("/publication/:title/participants/:personId", controller.removeParticipantToPublication);
};
